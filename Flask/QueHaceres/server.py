...
@app.route( "/multiplica/<int:num1>", methods = ['GET'] ) #poner el numero despues del /2/5
def multiplica_por_diez( num1 ):
    total = num1 * 10
    return f"{num1} x 10 = {total}"

@app.route( "/multiplica/<int:num1>/<int:num2>", methods = ['GET'] ) #poner el numero despues del /2/5
